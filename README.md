# WEB103 Project 4 - *PLANT KIT*

Submitted by: **Juri Rodriguez**

About this web app: **App to build a customized plant kit**
...
- [x] **The web app is connected to a PostgreSQL database, with an appropriately structured `CustomPlantKit` table**
  - [x] **NOTE: Your GIF must include a view of your Railway database that shows the contents of the table used by your app**
- [x] **The web app uses React to display data from the API**
- [x] **Users can view a list of options they can select for different aspects of a `CustomPlant`**
